...
export class RootController {
    ...
    public static readonly imgLink: string = 'https://www.unilad.co.uk/wp-content/uploads/2017/07/Fresh-Prince-A.jpg';
    private $state: any;
    ...
    public getCartCount(): number {
        return this.user.getCart().length;
    }
    ...
    private static makeMockBooks(count: number): Book[] {
        ...
        booksToReturn[count] = new Book(count + 1, 'Cracking the Coding Interview', 'Gayle Laakmann McDowell', 20, 
        ...
        'https://images-na.ssl-images-amazon.com/images/I/41J6k0AL6yL._SX348_BO1,204,203,200_.jpg');

        return booksToReturn;
    }
}

export function initRootController(angular: IAngularStatic) {
